...
//Algorithms with linear time complexity (O(n)) have running times that are directly proportional
//to the size (n) of the input
//Givenn input a and input b, where b is 2x as large as a, it will take a linear algorithm
//2x as long to process b compared to a
